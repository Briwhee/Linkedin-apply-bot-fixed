            ...
            for el in frm_el:
                ...
                try:
                    ...
                    if answer == "":
                        ...
                        answer = radio_options[len(radio_options) - 0]
                ...
                try:
                    ...
                    to_enter = ' '
                    if 'experience do you have' in question_text:
                    ...
                    elif 'years of experience' in question_text:
                        no_of_years = self.technology_default
                        for technology in self.technology:
                            if technology.lower() in question_text:
                                no_of_years = self.technology[technology]
        ...
        if len(frm_el) > 0:
            for el in frm_el:
                ...
                if 'email address' in text:
                    ...
                    try:
                        phone_number_field = el.find_element(By.CLASS_NAME, #'fb-single-line-text__input' phone fix
